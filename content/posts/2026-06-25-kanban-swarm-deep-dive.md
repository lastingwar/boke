...
date: 2026-06-25
tags: ["Hermes Agent", "Kanban Swarm", "多智能体", "AI Agent", "开源", "架构", "multi-agent", "orchestration"]
...
> **摘要**：本文深入剖析 Hermes Agent v0.16 的 Kanban Swarm 架构，从设计哲学到实战案例，全方位解读这个基于 SQLite 看板的多智能体协作系统。适合对 AI Agent 编排有兴趣的开发者阅读。
...
审核 Worker（reviewer profile，verifier gate）
  → 检查技术准确性、代码示例可运行性
  ↓
发布 Worker（publisher profile）
  → 格式优化、添加 frontmatter、提交 PR
  ↓
完成
```
